    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/departamento-pessoal/pontotel"
            className="flex items-center gap-2 border border-zinc-200 hover:border-zinc-300 text-zinc-600 hover:text-zinc-900 bg-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shrink-0"
          >
