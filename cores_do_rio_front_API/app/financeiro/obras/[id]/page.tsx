        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-5">
          <div>
            ...
            <div className="flex items-center gap-3 mt-1.5 text-xs text-zinc-400">
              ...
              <span>·</span>
              <span>{obra.pavimentos.reduce((s, p) => s + p.comodos.length, 0)} comodo{obra.pavimentos.reduce((s, p) => s + p.comodos.length, 0) !== 1 ? 's' : ''}</span>
            </div>
          </div>
              ...
              <button
                ...
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-xs text-zinc-400">{pav.comodos.length} comodo{pav.comodos.length !== 1 ? 's' : ''}</span>
                  </div>
                </div>
                    ...
                    return (
                      <div key={c.id} className="p-5">
                              ...
                              <div key={e.etapa}>
                                <div className="flex items-center justify-between mb-1">
                                  <div className="flex items-center gap-2">
                                    ...
                                    {e.concluida && (
                                      <span className="text-xs bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded-full font-medium">Concluida</span>
                                    )}
                                  </div>
                        ...
                        <div className="mt-4 pt-3.5 border-t border-zinc-100">
                          <div className="flex items-center justify-between mb-1">
                            <span className="text-xs font-bold text-zinc-700">Total Comodo</span>
